          ...
          return (
            ...
            >
              ...
              <div
                ...
                className={
                  isOpen
                    ? 'mt-4 text-gray-600 dark:text-gray-300 text-sm font-serif break-words whitespace-pre-line max-h-[1200px] opacity-100 overflow-hidden transition-[opacity,max-height]'
